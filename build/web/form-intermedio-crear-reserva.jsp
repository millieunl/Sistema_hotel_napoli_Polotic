                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <div class="pull-left">
                                ...
                                <p class="mb-30"> ¿Es la primera vez que se hospeda en Hotel Napoli?.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="custom-control custom-radio mb-5">
                                <input type="radio" id="customRadio2" name="es_nuevo" value = "true" class="custom-control-input">
                                <label class="custom-control-label" for="customRadio2">SI</label>
                            </div>
                            <div class="custom-control custom-radio mb-5">
                                <input type="radio" id="customRadio3" name="es_nuevo" value = "false" class="custom-control-input">
                        ...
                        <div class="col-lg-12 p-t-20 text-center">
                            <a class="btn btn-primary" href="form-crear-reserva-2.jsp">SI</a> <!--si es nuevo-->
                            <a class="btn btn-primary" href="form-crear-reserva-3.jsp">NO</a> <!-- no es nuevo-->
                        </div>
