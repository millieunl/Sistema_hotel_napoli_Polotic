                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario modificar lso datos de un empleado</h4>
                                <p class="mb-30">Modifique los campos que desee de este empleado.</p>
                            </div>

                        </div>

                        <!-- formulario para modificar empleados -->
                        <form  action=" ServModificarEmpleado" method = "GET">
                            <%
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name= "nombre" value="<%=empleado.getNombre()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "apellido" value="<%=empleado.getApellido()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "dni" value="<%=empleado.getDni()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker" name = "fecha_nac" value="<%=empleado.DateAString(empleado.getFecha_nac())%>" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "cargo" value="<%=empleado.getCargo()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "direccion" value="<%=empleado.getDireccion()%>">
                                </div>
                            </div>

                            <!--datos para la tabla usuario/login in -->
                            <h5 class="text-blue h5">Datos para el login</h5>
                            <p class="mb-30">Aqui puede modificar el nombre de  usuario y contraseña del usuario relacionado a este empleado</p>

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Nombre de usuario</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "usuario" value="<%=empleado.getUsuario().getNombre_usuario()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control"  name = "contrasenia" type="text" value="<%=empleado.getUsuario().getContrasenia()%>">
                                </div>
                            </div>
