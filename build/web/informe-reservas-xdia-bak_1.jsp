                        ...
                        <div class="clearfix">
                            ...
                            <div class="pull-left">
                                ...
                                <%
                                    ...
                                    String str_fecha = formatter.format(fecha_actual);
                                %>
                                <p class="mb-30">La lista de todas las reservas del hotel que se hicieron en el dia de hoy (<%= str_fecha %>).</p>
                            </div>
                        </div>

                        <!-- basic table  Start -->
                            <div class="clearfix mb-20">
                                <!--boton para recargar la pagina ver si tiene que ser input-->
