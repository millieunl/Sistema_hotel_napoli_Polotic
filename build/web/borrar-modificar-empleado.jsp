                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Borrar y modificar empleados</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Borrar y modificar empleado</h4>
                                <p class="mb-30">En esta sección podrá borrar o modificar un empleado del sistema.</p>
                        ...
                        <div class="pd-20 card-box mb-30">
                            <div class="clearfix mb-20">
                                <div class="pull-left">
                                    <h4 class="text-blue h4">Tabla Empleado </h4>
                                </div>
                            </div>
                            ...
                            <table class="table  table-hover">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        List <Empleado> lista_empleados = (List) request.getSession().getAttribute("lista_empleados");
                                    ...
                                    <tr>
                                        <%
                                           int id_empleado = emp.getId_persona();
                                            String dni = emp.getDni();
                                            String nombre = StringUtils.capitalize(emp.getNombre()) + " " + StringUtils.capitalize(emp.getApellido());
                                            Date fecha = emp.getFecha_nac();
                                            String fecha_nac = emp.DateAString(fecha);
                                            String direccion = emp.getDireccion();
                                            String cargo = emp.getCargo();
                                            int id_usuario =  emp.getIdUsuario();
                                        ...
                                        <td>
                                            ...
                                            la ID-->
                                            <form name = "form_borrar_empleado" action = "ServBorrarEmpleado" method = "POST">
                                        ...
                                        <td>
                                            ...
                                            la ID-->
                                            <form name = "form_modificar_empleado" action = "ServModificarEmpleado" method = "POST">
                                                <input type ="hidden" name ="id_empleado" value ="<%=id_empleado%>">
