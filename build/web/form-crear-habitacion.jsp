                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Agregar habitación</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para Agregar habitaciones</h4>
                                <p class="mb-30">Completar el formulario para dar de alta una habitación en el sistema.</p>
                            </div>

                        </div>

                        <!-- formulario para dar de alta habitaciones -->
                        <form action="ServAltaHabitacion" method="POST">
                            <!--campos caracteristicas habitacion-->
                            ...
                            <!-- tematica -->
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Nombre/temática</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name= "nombre_habitacion" placeholder="tematica">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    ...
                                    <!--ver como levantar cada tipo desde la tabla tipos-->
                                    <select class="custom-select col-12"  name = "tipo">
                                       
                                        <%
                                       HttpSession miSesion = request.getSession();
                                       List <TipoHabitacion> listaTipos = (List) request.getSession().getAttribute("listaTipos");
                                                                              
                                        for (TipoHabitacion tipo : listaTipos){    
                                            String tipoh= tipo.getTipo();  
                                            int idTipo = tipo.getId_tipo();

                                         %>
                                        <option value = "<%=idTipo %>"> <%=tipoh %></option>
                                        <% } %> 
