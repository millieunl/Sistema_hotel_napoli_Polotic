            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Buscar reservas por empleado </h4>
                                <p class="mb-30">Si ingresa la Id de un empleado y el rango de fechas que desea consultar, obtendra la lista de todas las reservas que se dieron de alta  un mismo empleado dentro del rango de fechas consultadas.</p>
                            </div>
                        </div>

                        <!-- formulario  -->
                        <form action="ServConsultaEmpleadoReserva" method="POST"> 
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese Id empleado</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control " name="id_empleado"
                                           placeholder="numero de empleado" type="text">
                                </div>
                            </div>

                            <!--fechas de alta de la reserva -->
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese una fecha desde</label>
                                <div class="col-sm-12 col-md-10">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese una fecha hasta</label>
                                <div class="col-sm-12 col-md-10">
