                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Ver todos los huespedes</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Lista de huespedes</h4>
                                <p class="mb-30">La lista de todas los huespedes del hotel que están ingresados en el sistema.</p>
                            </div>
                        </div>
