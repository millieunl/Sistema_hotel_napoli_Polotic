                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para modificar la reserva N°<%= request.getSession().getAttribute("id_reserva") %></h4>
                                <p class="mb-30">Puede elegir entre alguna de las habitaciones disponibles.</p>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        ...
                        <form action ="ServModificarReserva2" method = "GET">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    ...
                                    <select class="custom-select col-12"  name = "nro_habitacion_nueva">
                                       
                                       <%
                          
                                         for (Habitacion hab : lista) {  
                                            int nro_habitacion_nueva = hab.getNro_habitacion();
                                         %>
                                         
                                        <option value = "<%=nro_habitacion_nueva  %>" name = "nro_habitacion_nueva" ><%=hab.getNro_habitacion()   %>- <%= hab.getNombre_habitacion() %> - <%= hab.getTipo_habitacion().getTipo() %></option>
                                        <% } 
                            ...
                            <!--fechas para la reserva  y el HUESPED-->
                            <%
                               
                                Huesped huesped = (Huesped) miSesion.getAttribute("huesped");
                                Habitacion habitacion_vieja = (Habitacion) miSesion.getAttribute("habitacion_vieja");
                           ...
                           <div class="form-group row">
                            ...
                            <input type ="hidden" name ="id_reserva" value ="<%= reserva.getNro_reserva() %>">
