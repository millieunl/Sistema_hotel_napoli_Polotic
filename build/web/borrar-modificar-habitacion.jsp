                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Borrar o modificar habitación</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Borrar o modificar habitaciones</h4>
                                <p class="mb-30">En esta sección podrá borrar o modificar una habitación que este ingresada en el sistema.</p>
                                <div class="alert alert-danger" role="alert">
                                    Tenga mucho cuidado, recuerde que cualquier cambio será permanente.
                                </div>
                        ...
                        <div class="pd-20 card-box mb-30">
                            <div class="clearfix mb-20">
                                <div class="pull-left">
                                    <h4 class="text-blue h4">Tabla habitaciones </h4>
                                </div>
                            </div>
                            ...
                            <table class="table  table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><%=id_habitacion%></th>
                                        <td><%=nro_piso%> </td>
                                        <td><%=StringUtils.capitalize(nombre_hab)%> </td>
                                        <td><%=StringUtils.capitalize(tipo)%> </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            la ID-->
                                            <form id ="borrar" name = "form_borrar_habitacion" action = "ServBorrarHabitacion" method = "POST">
                                                <input  type ="hidden" id="id_habitacion" name ="id_habitacion" value ="<%=id_habitacion%>">
                                                <button  id="miboton" type="submit" class="btn btn-danger boton "><i class="dw dw-edit-2"></i></button>
                                                    ...
                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bg-danger text-white">
                                                            <div class="modal-body text-center">
                                                                <h3 class="text-white mb-15"><i class="fa fa-exclamation-triangle"></i> Alerta</h3>
                                                                <p>Esta seguro que desea borrar esto?.</p>
                                                                <button id="si" type="button" class="btn btn-light" data-dismiss="modal" >SI</button>
                                        ...
                                        <td>
                                            ...
                                            la ID-->
                                            <form  name = "form_modificar_habitacion" action = "ServModificarHabitacion" method = "POST">
