                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Consultar o modificar  tipos de habitación</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Consultar o modificar  tipos de habitaciones</h4>
                                <p class="mb-30">En esta sección podrá ver o modificar los diferentes tipos de habitacion que hay en el hotel.</p>
                            </div>
                        </div>
                        ...
                        <div class="pd-20 card-box mb-30">
                            <div class="clearfix mb-20">
                                <div class="pull-left">
                                    <h4 class="text-blue h4">Tabla de tipos de habitaciones </h4>
                                </div>
                            </div>
                            ...
                            <table class="table  table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Cantidad limite de personas</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        for (TipoHabitacion tipo : lista_tipo) {
                                            int id_tipo = tipo.getId_tipo();
                                            int cant_personas = tipo.getCantidad_limite();
                                            String nombre_tipo = tipo.getTipo();
                                            double precio_noche = tipo.getPrecio_noche();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            la ID-->
                                            <form name = "form_modificar_tipo" action = "ServModificarTipo" method = "POST">
