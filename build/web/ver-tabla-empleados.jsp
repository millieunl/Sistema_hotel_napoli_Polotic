                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <div class="pull-left">
                                ...
                                <p class="mb-30">La lista de todas los empleados del del hotel que están ingresados en el sistema.</p>
                            </div>
                        </div>
                                    ...
                                    <%
                                     ...
                                     <tr>
                                        <%
                                            ...
                                            int idEmpleado = emp.getId_persona();
                                            ...
                                            String fechaNac = emp.DateAString(fecha);
                                            String direccion = emp.getDireccion();
                                            String cargo = StringUtils.capitalize(emp.getCargo());
                                            int idUsuario =  emp.getIdUsuario();
