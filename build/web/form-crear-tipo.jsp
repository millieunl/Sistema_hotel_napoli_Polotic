                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para Agregar tipos de habitaciones</h4>
                                <p class="mb-30">Completar el formulario para dar de alta un tipo en el sistema.</p>
                            </div>

                        </div>

                        <!-- formulario para dar de alta tipo de habitaciones -->
                        <form id="input_field" action = "ServAltaTipoHabitacion" method="POST" >
                            <!--campos -->

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Tipo</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "tipo" placeholder="Single">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input  required class="form-control" type="number" min="1" max="6" name="cant_limite" placeholder=" escribir un numero">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input  required class="form-control" type="number" step=".01" name = "precio" placeholder="1500.32">
                                </div>
                            </div>
