                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Buscar reservas por fecha </h4>
                                <p class="mb-30">Aqui podra obtener las reservas programadas dentro de un rango de fecha que usted desee consultar
                                    Por favor ingrese una fecha de inicio de la reserva y otra fecha para establecer una fecha limite de busqueda.</p>
                            </div>
                        </div>

                        <!-- formulario  -->
                        <form action="ServConsultaReservaXfecha" method="GET"> 
                            <!--fechas para la reserva -->
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese una fecha de inicio</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker " name="fecha_ingreso"
                                           placeholder="Seleccionar fecha" type="text">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese una fecha limite</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker " name="fecha_egreso"
                                           placeholder="Seleccionar fecha" type="text">
                                </div>
                            </div>
