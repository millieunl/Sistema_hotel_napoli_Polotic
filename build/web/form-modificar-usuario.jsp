                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para modificar los datos del usuario <%=usuario.getNombre_usuario()%></h4>
                                <p class="mb-30">Modifique los campos que desee.</p>
                            </div>

                        </div>

                        <!-- formulario para modificar usuario solamente-->
                        <form  action=" ServModificarUsuario1" method = "GET">


                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Nombre de usuario</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "usuario" value="<%=usuario.getNombre_usuario()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control"  name = "contrasenia" type="text" value="<%=usuario.getContrasenia()%>">
                                </div>
                            </div>
