                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Reservas por empleado</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="pull-left">
                                ...
                                <%
                                    ...
                                    Empleado empleado = (Empleado) request.getSession().getAttribute("objeto_empleado");

                                    int id_empleado = empleado.getIdUsuario();
                                    String nombre_empleado = StringUtils.capitalize(empleado.getNombre()) + " " + StringUtils.capitalize(empleado.getApellido());
                                ...
                                %>
                                <h4 class="text-blue h4">Lista de reservas del empleado <%= nombre_empleado%>    </h4>
                                <p class="mb-30">Estas son las reservas que dio de alta el empleado <strong><%= nombre_empleado%>  con ID <%= id_empleado%> </strong> entre el dia <strong> <%=fecha_in%> </strong> hasta el dia <strong><%= fecha_eg%></strong> .</p>
                            </div>
                        </div>
                        ...
                        <table class="table ">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Fecha Alta reserva</th>
                            ...
                            <tbody>
                                <%
                                    List<Reserva> lista_reserva_empleado = (List) request.getSession().getAttribute("lista_reserva_empleado");
                                    ...
                                    for (Habitacion hab : lista_habitacion) {
                                        ...
                                        for (Reserva res : hab.getLista_reservas()) {
                                            ...
                                            for (Reserva res2 : lista_reserva_empleado) {

                                                if (res.getNro_reserva() == res2.getNro_reserva()) {

                                                    Date fecha = res2.getFecha_alta_reserva();
                                                    String fecha_alta_reserva = empleado.DateAString(fecha);
                                                    int id_reserva = res2.getNro_reserva();
                                                    int cant_dias = res2.getCant_total_dias_reserva();
                                                    double monto = res2.getMonto_total();
                                ...
                                <tr>
                                    ...
                                    <td><%= id_reserva%></td>
                                    <td><%=fecha_alta_reserva%></td>
                                    <td><%=nro_habitacion%></td>
                                    <td><%=StringUtils.capitalize(nombre_habitacion)%> - <%=StringUtils.capitalize(tipo_habitacion)%></td>
                                    <td><%=cant_dias%></td>
                                    <td><%= monto%></td>
                                </tr>
                                <% 
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-12 p-t-20 text-center">
                                <a class="btn btn-primary" href="informe-reservas-xempleado.jsp">Realizar otra consulta</a> <!--para hacer otra busqueda-->
                            </div>
                        </div>
                    </div><!-- fin contenedor-->
