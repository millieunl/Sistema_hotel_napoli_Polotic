...
@WebServlet(name = "ServCancelarModificarReserva", urlPatterns = {"/ServCancelarModificarReserva"})
public class ServCancelarModificarReserva extends HttpServlet {
   ...
   @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!lista_reserva.isEmpty() || lista_reserva != null ) {
            ...
            miSesion.setAttribute("lista_huesped", lista_huesped);
