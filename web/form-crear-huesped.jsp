<%-- 
    Document   : form-crear-huesped
    Created on : 27/07/2021, 22:39:51
                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Nuevo huesped</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para huésped</h4>
                                <p class="mb-30">Completar el formulario para registrar un huésped.</p>
                            </div>

                        </div>

                        <!-- formulario para registrar un huésped -->
                        <form action="ServAltaHuesped" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name="dni" placeholder=" dni sin puntos">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10 " >
                                    <input required class="form-control date-picker" name="fechaNac" placeholder="Seleccionar fecha"
                                           type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" type="text" name="profesion" placeholder=" una profesion">
                                </div>
                            </div>
