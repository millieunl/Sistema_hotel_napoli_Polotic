            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Reservas por hueped</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Lista de reservas por huesped </h4>
                                <p class="mb-30">Si ingresa la Id de un huesped  y las fechas que desea consultar, obtendra la lista de todas las reservas hechas por el mismo en un período desde/hasta.</p>
                            </div>
                        </div>

                        <!-- formulario  -->
                        <form action="ServConsultaHuepedReserva" method= "GET" > 
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Ingrese Id del huesped</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control " name="id_huesped"
                                           placeholder="numero de huesped" type="text">
                                </div>
                            </div>

                            <!--fechas para la reserva -->
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Fecha desde</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker " name="fecha_inicio"
                                           placeholder="Seleccionar fecha" type="text">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Fecha hasta</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker " name="fecha_fin"
                                           placeholder="Seleccionar fecha" type="text">
                                </div>
                            </div>

                            <!--boton para enviar todo el formulario -->
                            <div class="form-group row">
