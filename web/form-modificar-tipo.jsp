                ...
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Agregar tipo de habitación</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para modificar tipos de habitaciones</h4>
                                <p class="mb-30">Modificar alguno de los campos deseados para cambiar las caracteristicas del tipo  de habitación en el sistema.</p>
                            </div>

                        </div>

                        <!-- formulario para dar de alta tipo de habitaciones -->
                        <form id="input_field" action = "ServModificarTipo" method="GET" >

                            <%
                                HttpSession misesion = request.getSession();
                                TipoHabitacion tipo = (TipoHabitacion) misesion.getAttribute("tipo");
                            %>
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Tipo</label>
                                <div class="col-sm-12 col-md-10">
                                    <input  required class="form-control" type="text" name = "nombre_tipo" value="<%=tipo.getTipo()%>">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Cantidad limite de personas</label>
                                <div class="col-sm-12 col-md-10">
                                    <input  required class="form-control"  type="number" min="1" max="6" name="cant_personas" value="<%=tipo.getCantidad_limite()%>">
                                </div>
                            </div>

                            <!-- precio -->
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Precio por noche</label>
                                <div class="col-sm-12 col-md-10">
                                    <input  required class="form-control" type="number" step=".01" name = "precio_noche" value="<%=tipo.getPrecio_noche()%>">
                                </div>
                            </div>

                            <!--pasamos la id, esta oculta-->
                            <input type ="hidden" name ="id_tipo" value ="<%= tipo.getId_tipo()%>">
