<%-- 
    Document   : ver-tabla-empleados
    Created on : 28/07/2021, 16:50:09
                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Lista de reservas </h4>
                                <p class="mb-30">Aqui podra obtener las reservas que se dieron de alta dentro de un rango de fecha que usted desee consultar.</p>
                            </div>
                        </div>

                             <!-- formulario  -->
                        <form action="ServConsultaReservaXfechas" method="POST"> 
