...
<%@page import="Logica.ControladoraHotel"%>
...
<html>
    ...
    <body>
        ...
        <!--validacion para evitar que no entre nadie a esta seccion sin haber iniciado sesion -->
        <%
            
            //llamamos al metodo httpsession
            //tenemos una variable del tipo Httpsession, que nos permite guardar sesiones
            HttpSession miSesion = request.getSession();
            String usuario_sesion = (String)miSesion.getAttribute("usuario_sesion");

            //validamos si no esta autorizada  redirecciona al login
            if(usuario_sesion == null){
                response.sendRedirect("login.jsp");
                
            }
            else{
                //muestra todo el cuerpo 
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Hotel Napoli</li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                        <div class="blog-img">
                            <img src="vendors/images/logo6-napoli-grande.png" alt="">
                        </div>
                    </div>
                </div>
