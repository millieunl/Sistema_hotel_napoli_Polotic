                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                        <div class="alert alert-success alert-dismissible">
                            <h4 class="alert-heading"><i class="icon-copy fa fa-check-circle-o" aria-hidden="true"></i>
                                Acción realizada con éxito</h4>
                            <hr>
                            <p class="mb-0">Cierre este mensaje para ir a la página anterior</p>
