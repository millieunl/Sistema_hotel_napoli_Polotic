                ...
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            ...
                            <!--titulo contenedor-->
                            <div class="pull-left">
                                <h4 class="text-blue h4">Formulario para nuevo empleado</h4>
                                <p class="mb-30">Completar el formulario para dar de alta a un empleado en el sistema.</p>
                            </div>

                        </div>

                        <!-- formulario empleados -->
                        <form  action="ServAltaEmpleado" method = "POST">
                            <!--datos empleado-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="number" name = "dni" placeholder=" dni sin puntos">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control date-picker" name = "fechaNac" placeholder="Seleccionar fecha" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "cargo" placeholder="ventas">
                                </div>
                            </div>
                            ...
                            <p class="mb-30">Aqui debe crear un usuario y contraseña para poder loguearse en el sistema</p>

                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Nombre de usuario</label>
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text" name = "usuario" placeholder="usuario">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" value=" " name = "contrasenia" type="password">
                                </div>
                            </div>
