<%-- 
    Document   : form-cear-reserva2
    Created on : 02/08/2021, 03:35:33
    Author     : ciberella
--%>
                        ...
                        <div class="pb-20">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>$ <%= precio %></td>
                                    <td>
                                        <span class="<%=badge_esta_disponible%>"><%=mensaje_esta_disponible%>
                                        </span>
                                    </td>
                        ...
                        <form action ="ServAltaReserva" method = "POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input required class="form-control" type="text"name ="nro_habitacion" placeholder=" ">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input readonly class="form-control" name = "cant_personas" value= "<%= request.getSession().getAttribute("cant_personas")%>"  type = "text">
                                </div>
                            </div> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" type="text" name= "dni" placeholder=" dni sin puntos">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Id vendedor</label>
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" type="text" name="id_usuario" placeholder=" <%=request.getSession().getAttribute("usuario")%>">
                                </div>
